...
HTML_FILE = "ai_framework.html"   # read tickers from here
DATA_FILE = "finance_data.js"     # write data here (never overwrites HTML)
...
def embed_into_html(financial_data, as_of_str):
    ...
    content = (
        ...
        f"// Generated by fetch_market_data.py on {as_of_str}\n"
        "// Run: python3 fetch_market_data.py && git add finance_data.js && git push\n"
    ...
    print(f"Written {len(clean)} tickers ({kb:.0f} KB) to {DATA_FILE}")
    return True
